  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-[48px] font-semibold mb-12 tracking-tight text-[#1d1d1f]">Terms of Service</h1>
        <div className="space-y-12">
           <section>
              <h2 className="text-[24px] font-semibold text-[#1d1d1f] mb-4">1. Acceptance of Terms</h2>
           ...
           <section>
              <h2 className="text-[24px] font-semibold text-[#1d1d1f] mb-4">2. User Conduct</h2>
              <p className="text-[17px] text-[#1d1d1f] leading-relaxed">
           ...
           <section>
              <h2 className="text-[24px] font-semibold text-[#1d1d1f] mb-4">3. Intellectual Property</h2>
              <p className="text-[17px] text-[#1d1d1f] leading-relaxed">
           ...
           <section>
              <h2 className="text-[24px] font-semibold text-[#1d1d1f] mb-4">4. Limitation of Liability</h2>
              <p className="text-[17px] text-[#1d1d1f] leading-relaxed">
